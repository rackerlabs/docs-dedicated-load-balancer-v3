...
"""
Dedicated Load Balancer v3 API guide build configuration file.
...
project = 'Dedicated Load Balancer v3 API Reference'
...
extlinks = {
    ...
    'mycloud': ('https://mycloud.rackspace.com/%s', ''),
    'how-to': ('https://docs.rackspace.com/support/how-to/%s', ''),
...
html_title = 'Rackspace Technology Dedicated Load Balancer v3 API Guide'
...
latex_documents = [
    ('index', 'RackspaceManaagedLoadBalancerApiDoc.tex',
     'BPI Load Balancer API 3.0 Guide', 'Rackspace', 'manual')
]
